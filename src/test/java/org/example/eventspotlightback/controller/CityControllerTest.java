...
public class CityControllerTest {
    ...
    public void save_AddCityDto_Success() throws Exception {
        ...
        String jsonRequest = objectMapper.writeValueAsString(testAddCityDto);
    ...
    public void update_AddCityDto_Success() throws Exception {
        ...
        MvcResult result = mockMvc.perform(put("/cities/" + testCityId)
                        .content(jsonRequest)
                        .contentType(MediaType.APPLICATION_JSON)
                )
    ...
    public void delete_anyRequest_Success() throws Exception {
        Long testCityId = 99L;
        mockMvc.perform(delete("/cities/" + testCityId))
                .andExpect(status().isNoContent())
                .andReturn();

        mockMvc.perform(get("/cities/" + testCityId))
